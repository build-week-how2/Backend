...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({message: 'Failed to create new Hot To'})
  }
})
...
router.put('/:id', (req, res) => {
  ...
  .catch(err => {
    res.status(500).json({ message: 'Failed to update this How To' });
  });
});
